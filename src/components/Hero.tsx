        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <motion.div
              ...
              className="inline-flex items-center gap-2.5 px-4 py-2 bg-primary/10 rounded-full mb-6"
            >
          ...
          >
            {impact.map((stat, index) => (
              <motion.div
                ...
                className="rounded-2xl border bg-gradient-to-br from-primary/10 via-background to-background p-6 hover:border-primary/50 transition-colors"
              >
